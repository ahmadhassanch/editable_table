from reportlab.lib.colors import black, green, red, brown,blueviolet, pink, blue,white, transparent
...
for key in json_file:
    ...
    if key['type'] == "table":
        content = json.loads(key["content"])

        text, width_arr, colors = clean_json(content, text, width, col_span, color_arr)
